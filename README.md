...
<button onclick="pass1()">Unlock</button>
</div>

<div id="step2" class="box hidden">
<p>Sabar kro ruko zaraaaaaa ye bi kolo👉🏻👈🏻</p>
<input id="p2" type="password">
<button onclick="pass2()">Open</button>
</div>

<div id="step3" class="box hidden">
<p>Last password 🌚</p>
<input id="p3" type="password">
<button onclick="pass3()">Open</button>
</div>

<div id="final" class="message hidden">
